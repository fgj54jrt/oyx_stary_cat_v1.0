...
//		ViewCompat.setRotationY(mContent, 10 * offset);
		ViewCompat.setScaleX(mContent, 1+offset/2);
		ViewCompat.setScaleY(mContent, 1+offset/2);
		Log.w("lxh","offset = "+offset);
//		ViewCompat.setTranslationY(mContent, -offset*250);
		
		mViewBehind.setScaleX( 1-offset/6);
		mViewBehind.setScaleY( 1-offset/6);	
	}
