		...
		commit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(TextUtils.isEmpty(input.getText().toString().trim())){
					ActivityUtil.show(getActivity(), getString(R.string.oyx_edit_please_input));
				}else{
		...
		if(user != null && sign != null){
			...
			user.update(mContext, new UpdateListener() {
				...
				public void onSuccess() {
					// TODO Auto-generated method stub
					ActivityUtil.show(getActivity(), getString(R.string.oyx_edit_info_success));
				...
				public void onFailure(int arg0, String arg1) {
					// TODO Auto-generated method stub
					ActivityUtil.show(getActivity(), getString(R.string.oyx_edit_info_fail));
				}
			});
		}
	}
