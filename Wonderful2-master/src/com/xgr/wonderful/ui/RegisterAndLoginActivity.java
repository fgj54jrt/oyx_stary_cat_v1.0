...
public class RegisterAndLoginActivity extends BasePageActivity 
	...
	protected void setupViews(Bundle bundle) {
		// TODO Auto-generated method stub
		 actionbar.setTitle(getString(R.string.oyx_manage_account));
		...
		case R.id.register:
			if(operation == UserOperation.LOGIN){
				if(TextUtils.isEmpty(userNameInput.getText())){
					...
					Toast.makeText(mContext, getString(R.string.oyx_please_enter_name), Toast.LENGTH_SHORT).show();
					return;
				}
				if(TextUtils.isEmpty(userPasswordInput.getText())){
					userPasswordInput.setShakeAnimation();
					Toast.makeText(mContext, getString(R.string.oyx_please_enter_password), Toast.LENGTH_SHORT).show();
					return;
				}
				...
				if(TextUtils.isEmpty(userEmailInput.getText())){
					...
					Toast.makeText(mContext, getString(R.string.oyx_please_enter_email), Toast.LENGTH_SHORT).show();
					return;
				}
				if(!StringUtils.isValidEmail(userEmailInput.getText())){
					userEmailInput.setShakeAnimation();
					Toast.makeText(mContext, getString(R.string.oyx_email_is_wrong), Toast.LENGTH_SHORT).show();
					return;
				}
	...
	private void updateLayout(UserOperation op){
		if(op == UserOperation.LOGIN){
			...
			registerButton.setText(getString(R.string.oyx_login));
			...
			registerButton.setText(getString(R.string.oyx_register));
		}else{
			loginTitle.setTextColor(Color.parseColor("#888888"));
			loginTitle.setBackgroundDrawable(null);
			loginTitle.setPadding(16, 16, 16, 16);
			...
			userEmailInput.setVisibility(View.VISIBLE);
			registerButton.setText(getString(R.string.oyx_find_password));
		}
	}
	...
	public void onLoginSuccess() {
		// TODO Auto-generated method stub
		dimissProgressbar();
		ActivityUtil.show(this, getString(R.string.oyx_login_success));
	...
	public void onLoginFailure(String msg) {
		// TODO Auto-generated method stub
		dimissProgressbar();
		ActivityUtil.show(this, getString(R.string.oyx_login_fail));
	...
	public void onSignUpSuccess() {
		// TODO Auto-generated method stub
		dimissProgressbar();
		ActivityUtil.show(this, getString(R.string.oyx_register_success));
	...
	public void onSignUpFailure(String msg) {
		// TODO Auto-generated method stub
		dimissProgressbar();
		ActivityUtil.show(this, getString(R.string.oyx_register_fail));
	...
	public void onResetSuccess() {
		// TODO Auto-generated method stub
		dimissProgressbar();
		ActivityUtil.showL(this, getString(R.string.oyx_find_password_in_email));
	...
	public void onResetFailure(String msg) {
		// TODO Auto-generated method stub
		dimissProgressbar();
		ActivityUtil.show(this, getString(R.string.oyx_find_password_error));
		LogUtils.i(TAG,"register failed！");
	}
